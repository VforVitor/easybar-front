...
export default function TabList() {
  return (
    <div className="flex flex-col items-center w-full bg-gray-100">
      <Accordion type="single" collapsible className="w-full px-4 py-4">
          ...
          <AccordionContent>
            <div className="flex flex-col space-y-4">
              {Array.from({ length: 6 }).map((_, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-white rounded-lg shadow-md mt-5">
                  <span className="text-primary">Tab #{String(index + 1).padStart(4, "0")}</span>
